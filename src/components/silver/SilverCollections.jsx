...
import imgRings      from '../../assets/collections/silver/silver-ring.jpg';
...
const collections = [
  { title: 'Silver Chains',        desc: 'Refined silver chains in classic and contemporary styles.',          img: imgChains },
  { title: 'Anklets',              desc: 'Delicate silver anklets in traditional and modern designs.',         img: imgAnklets },
  { title: 'Bracelets',            desc: 'Lightweight silver bracelets for everyday elegance and gifting.',    img: imgBracelets },
  { title: 'Silver Rings',         desc: 'Classic and statement silver rings crafted with artistry.',          img: imgRings },
  { title: 'Silver Gift Articles', desc: 'Premium silver gift pieces for every milestone and celebration.',    img: imgGifts },
  { title: 'Pooja Collections',    desc: 'Sacred silver articles and pooja items crafted with devotion.',      img: imgPooja },
  { title: 'Customized Gifts',     desc: 'Personalized silver gifts engraved and designed for you.',           img: imgCustom },
  { title: 'Kids Accessories',     desc: 'Safe, delicate silver jewellery made for children.',                 img: imgKids },
];
      ...
      {modal && (
        <div onClick={() => setModal(null)} style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(0,0,0,0.88)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
          <div onClick={e => e.stopPropagation()} style={{ position: 'relative', maxWidth: '700px', width: '100%', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.6)' }}>
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'linear-gradient(to top,rgba(20,22,26,0.92) 0%,transparent 60%)', padding: '32px 24px 20px' }}>
