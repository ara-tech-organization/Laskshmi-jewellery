...
const features = [
  { icon: Shield,      label: 'Pt950 Purity',   sub: 'Hallmarked certified' },
  { icon: Star,        label: '500+ Designs',   sub: 'Exclusive collections' },
  { icon: Heart,       label: 'Couple Designs', sub: 'Perfect for gifting' },
  { icon: CheckCircle, label: 'Premium Quality', sub: 'Lifetime durability' },
];

export default function PlatinumIntro() {
  ...
  return (
    <section ref={ref} style={{ background: '#FAF6EE', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="plat-intro-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'center' }}>

          <div className="rp" style={{ position: 'relative' }}>
            ...
            <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 28px 72px rgba(20,12,5,0.14)', position: 'relative' }}>
              <img src={PlatinumHeroImg} alt="Platinum Jewellery" style={{ width: '100%', height: '500px', objectFit: 'cover', objectPosition: 'center', display: 'block' }} />
            ...
            <div style={{ position: 'absolute', bottom: '-20px', left: '32px', background: `linear-gradient(135deg,${GOLD},${GOLD_DARK})`, borderRadius: '18px', padding: '18px 24px', boxShadow: '0 6px 18px rgba(212,173,90,0.18)' }}>
              <div style={{ fontSize: '36px', fontWeight: '800', color: '#fff', lineHeight: 1 }}>950</div>
              <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.85)', marginTop: '3px', letterSpacing: '1.5px', textTransform: 'uppercase' }}>Pt Purity</div>
            </div>
          ...
          <div>
            <div className="rp" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '6px 16px', background: 'rgba(146,46,97,0.10)', border: '1px solid rgba(146,46,97,0.35)', borderRadius: '50px', marginBottom: '22px' }}>
              <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#922e61', display: 'block' }} />
              <span style={{ fontSize: '11px', fontWeight: '600', letterSpacing: '2px', textTransform: 'uppercase', color: '#922e61' }}>About Our Platinum</span>
            </div>
            <h2 className="rp" style={{ fontSize: 'clamp(26px,3vw,42px)', fontWeight: '700', color: '#1A1610', lineHeight: '1.2', letterSpacing: '-0.5px', marginBottom: '12px' }}>Sophistication of</h2>
            <h2 className="rp" style={{ fontSize: 'clamp(26px,3vw,42px)', fontWeight: '700', color: GOLD, lineHeight: '1.2', letterSpacing: '-0.5px', marginBottom: '28px' }}>Modern Luxury</h2>
            <div className="rp" style={{ width: 48, height: 3, background: `linear-gradient(to right,${GOLD},rgba(212,173,90,0.15))`, borderRadius: '2px', marginBottom: '28px' }} />
            <p className="rp" style={{ fontSize: '15px', lineHeight: '1.95', color: '#5A4F3F', marginBottom: '16px' }}>
              Experience the sophistication of platinum jewellery designed for contemporary elegance. Known for its rarity, durability, and premium appeal, platinum symbolizes everlasting love and refined luxury.
            </p>
            <p className="rp" style={{ fontSize: '15px', lineHeight: '1.95', color: '#5A4F3F', marginBottom: '36px' }}>
              Our platinum collections are crafted for individuals who appreciate minimal beauty with timeless sophistication — every piece in Pt950 purity with enduring natural lustre.
            </p>
            <div className="rp" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
      ...
      <style>{`@media (max-width: 960px) { .plat-intro-grid { grid-template-columns: 1fr !important; gap: 40px !important; } }`}</style>
    </section>
  );
}
