...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="container"
        style={{ position: "relative", zIndex: 2, padding: "80px 24px 60px" }}
      >
        <div style={{ maxWidth: "560px" }}>
          ...
          >
            From grand bridal sets to elegant everyday pieces — every jewel
            crafted with certified purity and exceptional artistry for every
            cherished moment.
          </p>
            ...
            {stats.map(({ num, label }, i) => (
              <div
                ...
                style={{
                  ...
                  borderRight:
                    i < 2 ? "1px solid rgba(212,173,90,0.22)" : "none",
                }}
              >
                <div
                  style={{
          ...
          >
            ...
            >
              All jewellery{" "}
              <strong style={{ color: "#d4ad5a", fontWeight: "600" }}>
                BIS Hallmarked
              </strong>{" "}
              & certified
            </span>
      ...
      >
        <div style={{ display: "flex", gap: "3px", marginBottom: "4px" }}>
          {[1, 2, 3, 4, 5].map((s) => (
            <Star key={s} size={11} fill="#d4ad5a" color="#d4ad5a" />
          ))}
        </div>
        <div
          style={{
