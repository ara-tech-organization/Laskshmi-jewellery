...
export default function ContactMap() {
  return (
    <section style={{ background: '#922e61', padding: '0' }}>
      <div className="contact-map-wrap" style={{ width: '100%', height: '400px', background: 'linear-gradient(135deg,#922e61,#7a2451)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ textAlign: 'center', zIndex: 1 }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.45)', margin: '0 0 24px' }}>111, Sarangapani East Street, Kumbakonam — 612001</p>
          <a href="https://www.google.com/maps/search/111+Sarangapani+East+Street+Kumbakonam+612001" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 28px', background: 'linear-gradient(135deg,#d4ad5a,#b08a3a)', color: '#fff', textDecoration: 'none', borderRadius: '50px', fontSize: '14px', fontWeight: '600', boxShadow: '0 3px 12px rgba(212,173,90,0.18)', transition: 'all 0.3s ease' }}
